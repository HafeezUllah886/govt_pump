...
class SlaughteringController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('slaughtering.create', compact('products', 'customers', 'factories', 'butchers', 'warehouses'));
    }
    ...
    public function store(Request $request)
    {
       ...
       try
       {
        ...
        $notes_for_butcher = "Pending Amount of " . $request->rejected_weight . "Kg " . $product->name . " at " . $request->rejected_price . " per Kg in " . $factory->title . " of " . $customer->title;
        createTransaction($butcher->id, $request->date, $rejected_total, 0, $notes_for_butcher, $ref);

        $notes_for_ober = "Pending Amount of " . $request->ober_qty . " ober of " . $product->name . " at " . $request->ober_price . " per ober in " . $factory->title . " of " . $customer->title;
        ...
        createStock($request->product_id, 0, $request->qty, $request->date, $notes_for_stock, $ref, $request->warehouse);
    ...
    public function edit($id)
    {
        ...
        return view('slaughtering.edit', compact('slaughter', 'products', 'customers', 'factories', 'butchers', 'warehouses'));
    }
